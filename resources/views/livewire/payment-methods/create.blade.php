<div class="paymentform-scope flex h-full w-full flex-1 flex-col gap-6 items-stretch">
    <style>
        .paymentform-scope {
        ...
        [data-theme="light"] .paymentform-scope,
        .theme-light .paymentform-scope {
            --surface: #FFFFFF;
            --surface-2: #F5F7F9;
            --text: #0E1420;
            --muted: #4A5568;
        ...
        [data-theme="dark"] .paymentform-scope,
        .theme-dark .paymentform-scope {
            --surface: #0F1720;
            --surface-2: #111827;
            --text: #E6EDF3;
            --muted: #8BA0B5;
        ...
        [data-theme="dark"] .paymentform-scope .paymentform-title-badge,
        .theme-dark .paymentform-scope .paymentform-title-badge {
            background: radial-gradient(circle at 0% 0%, rgba(26, 168, 85, 0.32), transparent 55%),
                        rgba(15, 23, 42, 0.5);
        }

        .paymentform-title-icon {
            display: inline-flex;
            align-items: center;
            justify-content: center;
            width: 26px;
        ...
        .paymentform-scope input[type="text"],
        .paymentform-scope input[type="search"],
        .paymentform-scope select {
            background: var(--surface);
        ...
        .paymentform-scope input::placeholder {
            color: rgba(148, 163, 184, 0.9);
        }

        .paymentform-scope input:focus-visible,
        .paymentform-scope select:focus-visible {
            border-color: rgba(26, 168, 85, 0.9);
            box-shadow: 0 0 0 2px rgba(26, 168, 85, 0.18);
            transform: translateY(-0.5px);
        }

        .paymentform-scope input:disabled {
            opacity: 0.65;
            cursor: not-allowed;
        }

        [data-theme="dark"] .paymentform-scope input[type="text"],
        [data-theme="dark"] .paymentform-scope input[type="search"],
        [data-theme="dark"] .paymentform-scope select,
        .theme-dark .paymentform-scope input[type="text"],
        .theme-dark .paymentform-scope input[type="search"],
        .theme-dark .paymentform-scope select {
            background: #020617;
        ...
        .paymentform-scope .text-error,
        .paymentform-scope .form-error {
            color: var(--error);
            font-size: 0.75rem;
        }
        ...
        .paymentform-submit:hover {
            filter: brightness(1.03);
            transform: translateY(-1px);
        }

        .paymentform-submit:focus-visible {
            outline: 3px solid rgba(26, 168, 85, 0.32);
            outline-offset: 2px;
        }

        .paymentform-submit:disabled {
            opacity: .7;
            cursor: not-allowed;
            box-shadow: none;
        }

        .paymentform-back-btn {
            display: inline-flex;
            align-items: center;
            gap: 0.35rem;
        ...
        .paymentform-back-btn svg {
            width: 18px;
            height: 18px;
        }

        .paymentform-back-btn:hover {
            filter: brightness(1.03);
            transform: translateY(-1px);
            box-shadow: 0 14px 32px -18px rgba(26, 168, 85, 0.85);
        }

        .paymentform-back-btn:focus-visible {
            outline: 2px solid rgba(26, 168, 85, 0.45);
            outline-offset: 2px;
        }

        [data-theme="dark"] .paymentform-scope .paymentform-back-btn,
        .theme-dark .paymentform-scope .paymentform-back-btn {
            background: radial-gradient(circle at 0% 0%, rgba(26, 168, 85, 0.32), transparent 55%),
                        rgba(15, 23, 42, 0.55);
            color: #E6EDF3;
    ...
    <form wire:submit="save" class="paymentform-form">
