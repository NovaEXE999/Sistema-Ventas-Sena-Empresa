...
<head>
    ...
    {{-- Assets principales de la app (por si se requieren estilos/scripts globales) --}}
    ...
    <div class="wrapper">
        ...
        <div class="right">
            <div class="login-box">
                ...
                @if ($errors->any())
                    <div class="alert alert-danger py-2 mb-3">Revisa los campos marcados para continuar.</div>
                @endif
