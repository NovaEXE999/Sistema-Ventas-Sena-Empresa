<div class="users-scope flex h-full w-full flex-1 flex-col gap-4 rounded-xl p-4 sm:p-6">
    <style>
        .users-scope {
        ...
        [data-theme="light"] .users-scope,
        .theme-light .users-scope {
            --surface: #FFFFFF;
            --surface-2: #F5F7F9;
            --text: #0E1420;
            --muted: #4A5568;
        ...
        [data-theme="dark"] .users-scope .users-table tbody tr:nth-child(even),
        .theme-dark .users-scope .users-table tbody tr:nth-child(even) {
    ...
    @if (session('success'))
        ...
        >
            <div class="users-alert-header">
                <div class="users-alert-icon" aria-hidden="true">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="h-5 w-5" aria-hidden="true">
                        <path fill-rule="evenodd" d="M10 18a8 8 0 1 0 0-16 8 8 0 0 0 0 16Zm3.857-9.809a.75.75 0 0 0-1.214-.882l-3.483 4.79-1.88-1.88a.75.75 0 1 0-1.06 1.061l2.5 2.5a.75.75 0 0 0 1.137-.089l4-5.5Z" clip-rule="evenodd" />
                    </svg>
                </div>
                <div class="flex flex-col gap-0.5">
                    <h3 class="users-alert-title">Mensajes de gestión de usuarios</h3>
                    <p class="users-alert-text">{{ session('success') }}</p>
                </div>
                <button
                    type="button"
    ...
    <div class="users-table-wrapper w-full mt-2">
        <h2 class="users-table-title">Gestión de usuarios</h2>
                ...
                <tbody>
                    @forelse ($users as $user)
                        <tr>
                            ...
                            <td>
                                <span class="badge {{ $user->status ? 'badge-status-active' : 'badge-status-inactive' }}">
                    ...
                    @empty
                        <tr>
                            <td colspan="7" class="users-muted text-center py-4">
