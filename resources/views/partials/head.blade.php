...
@php
    ...
    $pageTitles = [
        ...
        'sales.reports.pdf' => 'Factura de venta',
        'sales.reports.download' => 'Factura de venta',
        ...
        'productdeliveries.reports.pdf' => 'Comprobante entrega de inventario',
        'productdeliveries.reports.download' => 'Comprobante entrega de inventario',
        ...
        'reports.reports.pdf' => 'Reporte mensual',
        'reports.reports.download' => 'Reporte mensual',
        'profile.edit' => 'Perfil',
        'user-password.edit' => 'Contraseña',
        'two-factor.show' => 'Verificacion de dos metodos',
